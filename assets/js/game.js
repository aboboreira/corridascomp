...
var graphicAssets = {
    ballURL: 'assets/game/ball.png',
    ballName: 'ball',
    
    paddleURL: 'assets/game/paddle.png',
    paddleName: 'paddle',
};
...
var labels = {
    clickToStart: 'Jogador da esquerda: A vai pra cima, Z pra baixo.\n\nJogador da direita: Setinhas pra cima e pra baixo.\n\nQuem fizer 11 primeiro vence! \n\n- clique pra começar -',
    winner: 'Vencedor!',
};
